...
- "It's normal to say 'hello' when meet someone," means that this is expected or correct behavior.
...
In the normal-distribution model, it's common to use $\pm 2$ standard deviations as defining "unusual" or "surprising." That is, when a value (e.g. the age of the mother) is outside the interval central interval in the normal-distribution model, it's regarded as atypical.
